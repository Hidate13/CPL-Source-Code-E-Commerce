						...
						<div class="cart-item">
							...
							<div class="ci-details">
								...
								<div class="ci-actions">
									<a class="delete"
										onclick="window.location.href='/remove_from_cart?cId=${c.id}'"><i
										class="fa fa-trash-o " style="font-size: 25px; color: red"></i></a>
...
<c:forEach items="${cartItems }" var="c" varStatus="item">
	<dialog id="editAmountModal${item.count }" class="modal"
