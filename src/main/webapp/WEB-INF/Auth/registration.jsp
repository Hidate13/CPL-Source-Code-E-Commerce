		...
		<div class="tb-container align-center justify-between">
			...
			<section class="tb-form flex-col">
				...
				<sf:form id="registrationForm" class="form-card" autocomplete="off"
					onsubmit="validateRegistration(event)" method="post"
					action="sign_up" modelAttribute="user">

					<label class="input-group flex-col">Full Name <input
						id="fullname" type="text" required="true"
						placeholder="Eg: Mark Rox" autocomplete="off"
						onkeyup="validateFullname()" name="fullname" path="fullname"
						maxlength="50" />
					</label>
					<label class="input-group flex-col">Username <input
						id="username" type="text" required="true"
						placeholder="Eg: MarkRox01" autocomplete="off"
						onkeyup="validateUsername()" name="username" path="username"
						maxlength="16" />
					</label>
			...
			<div class="tb-image disappear">
				<img alt="Registration Graphic"
					src="graphics/registration-success.svg">
			</div>
		</div>
	</div>
</main>
