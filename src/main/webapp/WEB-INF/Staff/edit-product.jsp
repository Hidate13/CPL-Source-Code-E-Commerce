	...
	<div class="width-limiter" style="padding: 0rem 2rem;">
		...
		<section
			...
			<sf:form class="flex-col align-center" style="gap: 1rem;"
				method="post" action="edit_product?pId=${id }"
				...
				<label class="input-group flex-col" style="margin: 1rem 0rem 2rem;">Amount
					in stock<input type="number" required autocomplete="off"
					name="stock" value="${stock }" style="width: 200px;"
					oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
				</label>

				<label class="input-group flex-col" style="margin: 1rem 0rem 2rem;">Price
					(USD) <input type="number" required autocomplete="off" name="price"
